...
def parse_args():
    ...
    parser.add_argument("--sweep-start", type=float, default=5.9)
    parser.add_argument("--sweep-end", type=float, default=6.1)
    parser.add_argument("--sweep-count", type=int, default=10001)
